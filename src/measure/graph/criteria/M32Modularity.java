...
public class M32Modularity<V, E> extends RelativeCommunityCriteria<V,E> {

	public M32Modularity(Graph<V, E> graph) {
		super(graph);
	}
	...
	public double evaluateCommunities(Vector<Graph<V,E>> communities){
		...
		Max =  2 * graph.getVertexCount(); //Original formula
		...
		modularity  = (modularity - E )/E ;// (modularity - E );  Original formula
		return modularity;
	}
