...
public class M33Modularity<V, E> extends RelativeCommunityCriteria<V,E> {

	public M33Modularity(Graph<V, E> graph) {
		super(graph);
	}
	...
	public double evaluateCommunities(Vector<Graph<V,E>> communities){
		...
		Max =  graph.getVertexCount()*graph.getVertexCount(); //Original formula
