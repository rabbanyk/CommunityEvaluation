...
public class M6Modularity<V, E> extends RelativeCommunityCriteria<V,E> {

	public M6Modularity(Graph<V, E> graph) {
		super(graph);
	}
	...
	public double evaluateCommunities(Vector<Graph<V,E>> communities){
		...
		modularity  = (modularity - E )/(E - 1) ;// (modularity - E );  Original formula
		return modularity;
	}
